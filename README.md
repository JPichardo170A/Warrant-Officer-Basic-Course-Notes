...
| ⚔️ **[169CPT-CCTC](https://github.com/JPichardo170A/169CPT-CCTC)** | Technical labs & operational reference | OS · Networking · Security · SSH Tunneling |
...
|:-:|--------|----------------|:-----:|
| `00` | [🖥️ CVTE HowTo](00_WOBC_Cvte_HowTo/) | VM setup · CVTE orientation | 2 |
| `01` | [🐍 Python](01_Python/) | Data types · Functions · OOP · Networking · Regex | 20 |
| `02` | [⚡ PowerShell](02_PowerShell/) | Scripting · Remoting · Automation · Troubleshooting | 11 |
| `03` | [🛡️ Defensive Cyberspace Ops](03_Defensive%20Cyberspace%20Operations/) | DCO Foundations · Recon · Analysis · Crew Lead Ops | 5 |
| `04` | [☁️ Cloud Foundations](04_Cloud%20Foundations/) | IAM · AWS/Azure · Incident Response · Threat Hunting | 6 |
...
| 🗺️ Miro Main Board | Visual networking concepts and lab diagrams | [View Board](https://miro.com/app/board/o9J_klSqCSY=/?share_link_id=16) |
...
> ⚠️ Instructor-maintained via third-party platform — not officially supported by CCTC. Use **Google Chrome** for best results.
